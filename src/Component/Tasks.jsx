...
export default function Tasks() {
  ...
  return (
    <div className="flex flex-col justify-start ">
      {/* Add Task */}
      <div className="flex justify-between rounded-lg p-4 m-4 shadow-xl">
        <div className="flex flex-col  items-start ml-4  ">
          <span className="text-gray-500">October 26, 2022</span>
          <span className="font-semi-bold text-2xl ">Tuesday</span>
        </div>
        <button
          className="flex justify-center items-center mr- mt-1 max-h-12 px-4 rounded-lg text-white text-sm bg-gradient-to-r from-emerald-300 to-emerald-400 tracking-wider"
          onClick={null}
        >
